...
${SUDO_JUSER} cp -R ${DIR}/IJulia/structjump ${CFG_DIR}/.juliabox/structjump
${SUDO_JUSER} cp -R ${DIR}/IJulia/structjump_console ${CFG_DIR}/.juliabox/structjump_console
${SUDO_JUSER} cp -R /home/${USER}/workspace ${CFG_DIR}/.juliabox/workspace
